...
int main()
{
	...
	cout<<"************開發者碎碎念************"<<endl
		<<"物種保護等級是根據 IUCN紅色名錄 的等級畫分"<<endl
		<<"做這個小程式不過是因為自己喜歡動物以及受某桌遊的啟發罷了"<<endl
		<<"但是希望大家都能愛護環境，現有物種已經越來越少"<<endl
		<<"一起幫忙阻止讓更多有趣的生物消失"<<endl 
		<<"好嗎?"<<endl
		<<"************************************";
...
int start()		//開頭&說明 
{
	cout<<"你是一隻35億年前的藍綠菌"<<endl
		<<"你將經歷一系列的事件和危險"<<endl
		<<"想辦法生存下去並盡可能的進化吧"<<endl;
	getchar();		//按任意鍵繼續 
	cout<<"遊戲說明: "<<endl
		<<"1.初始值為進化值:0 ,食物:10 ,族群大小:10"<<endl 
		<<"2.每回合可選擇覓食或是骰骰子，覓食可獲得食物，骰骰子將會觸發隨機事件"<<endl
		<<"3.無論是覓食或是隨機事件都將隨機增加年分"<<endl
		<<"4.當年分>=0億年(也就是到現代時)，或是食物<0或族群<=0時，遊戲結束"<<endl<<endl; 
}
